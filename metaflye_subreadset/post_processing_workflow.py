...
def main():
    errors = []
    first_pass_dir = Path("/nfs/chisholmlab001/kve/2021_HIFI_Genome_Closing_Project/assembly")
    all_dfs = {}
    for batch_dir in sorted(first_pass_dir.iterdir()):
        if batch_dir.is_dir():
    ...
    all_assembly_report.to_csv(first_pass_dir / f"all_batches_assembly_report.tsv", sep='\t')
